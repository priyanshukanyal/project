...
<body>
    ...
    <nav>
         <ul>
           ...
           <li><a href="v1event.jsp">View event</a></li>
            <li><a href="o1event.jsp" class="active">View organizer </a></li>
    ...
    <%@ page session="true" %>
        ...
        <%
        String sql2="select * from aevent "; 
	Statement st2=connection.createStatement();
	ResultSet rs1=st2.executeQuery(sql2);
	%>
        <br/><br/>
         <center>
             <h2><font color="black" size="5"> View organizer</font></h2>
        <style>
        td{
            text-align: center;
            height: 25px;
        ...
        <th><font color="black">Organiser</th>
        ...
        <td><font color="black"><%=rs1.getString("organiser")%></td>
